...
public class ShopAuthMapDaoTest {
     ...
     */
    @Test
    public void testBQqueryShopAuth() throws Exception {
        //测试queryShopAuthMapListByShopId
        List<ShopAuthMap> shopAuthMapList = shopAuthMapDao.queryShopAuthListByShopId(1, 0, 2);
        assertEquals(1, shopAuthMapList.size());
        //测试queryShopAuthCountById
    ...
    public void testCUpdateShopAuthMap() throws Exception {
        List<ShopAuthMap> shopAuthMapDaoList = shopAuthMapDao.queryShopAuthListByShopId(1, 0, 1);
        shopAuthMapDaoList.get(0).setTitle("CCO");
        shopAuthMapDaoList.get(0).setTitleFlag(2);
        int effecteNum = shopAuthMapDao.updateShopAuthMap(shopAuthMapDaoList.get(0));
    ...
    public void testDeleteShopAuthMap() throws Exception{
        List<ShopAuthMap> shopAuthMapList1 = shopAuthMapDao.queryShopAuthListByShopId(1, 0, 1);
        List<ShopAuthMap> shopAuthMapList2 = shopAuthMapDao.queryShopAuthListByShopId(2, 0, 1);
